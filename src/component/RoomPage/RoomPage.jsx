...
const RoomPage = () => {
  const RoomSharingdata = [
    {
      text: "Single Rooom Details",
      rent: "8,500/M",
      security: "8,500",
    },
    {
      text: "Double Sharing Rooom Details",
      rent: "6,000/M",
      security: "6,000",
    },
    {
      text: "Three Sharing Room Details",
      rent: "5,000/M",
      security: "5,000",
    },
  ];
  ...
  return (
    <>
      <div className="  bg-slate-100 mx-10">
        ...
        <div className="flex items-center justify-between border mt-3 bg-white">
        ...
        <div className="mt-4 flex h-full">
          <div className="w-2/3  ">
            ...
            {RoomSharingdata.map((data, i) => (
              <div key={i} className=" mt-3 bg-white p-3 ">
                <label className="RoomSharingcard "> {data.text}</label>
                <div className=" md:flex  p-5  justify-between">
                  <p className="   md:gap-11   justify-between  md:justify-start flex  w-[100%]   md:min-w-[50%]">
                    <span>Rent for single Occupancy</span>
                    <span className=" font-semibold">₹{data.rent} </span>
                  </p>
                  <p className="  md:gap-11   justify-between  md:justify-start flex  w-[100%]   md:min-w-[50%] ">
